...
class DungeonLevelAdapter(private val activity: Activity, private val dataList: ArrayList<DungeonLevelModel>) : RecyclerView.Adapter<DungeonLevelAdapter.ViewHolder>() {
